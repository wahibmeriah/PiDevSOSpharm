...
public class AffPharmacien extends javax.swing.JFrame {

    /**
     * Creates new form Client
     */
    public AffPharmacien() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AffPharmacien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AffPharmacien().setVisible(true);
            }
        });
    }
